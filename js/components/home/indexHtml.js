...
export async function heroBanner(){
    try{
        ...
        const heroBannerImg = "https://semester-project-2-serinemarie.herokuapp.com" + data.hero_banner.formats.large.url;
        const heroBannerResponsive = "https://semester-project-2-serinemarie.herokuapp.com" + data.hero_banner.url;        
