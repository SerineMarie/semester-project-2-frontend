...
export async function oneProduct(){
    try{ 
        ...
        console.log(json)
        const productImg = "https://semester-project-2-serinemarie.herokuapp.com" + json.image.formats.medium.url;
        const productImgSmall = "https://semester-project-2-serinemarie.herokuapp.com" + json.image.formats.thumbnail.url;
